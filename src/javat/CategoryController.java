...
public class CategoryController {
    ...
    public String deleteTodo(ModelMap model, @RequestParam (defaultValue = "") String id) throws SQLException, ClassNotFoundException
    {
    ...
    public String seetodo(ModelMap model, @RequestParam (defaultValue = "") String id) throws SQLException, ClassNotFoundException
    {
        ...
        if (x.size()==0){
            model.put("errorMessage", "No items in this catagory");
            return "redirect:/Category";
        }
